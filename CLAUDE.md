...
- I'm using Unity Atoms. Much of the time, Unity Atoms can be overkill when you can just create simple linkages, but it should be used in some cases if it may add substantial benefit for maintability. If a situation arises that looks like a good use for it, ask me if we should use it in the implementation.
